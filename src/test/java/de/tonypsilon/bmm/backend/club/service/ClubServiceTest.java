...
class ClubServiceTest {
    ...
    void testCreateClubInvalidName() {
        ...
        assertEquals("Der Name des Clubs darf nicht leer sein!", nameNullException.getMessage());
        ...
        assertEquals("Der Name des Clubs darf nicht leer sein!", nameBlankException.getMessage());
